...
function createHelix( material, radius, tube, radialSegments, tubularSegments, height, arc, clockwise )
{
	...
	for ( var i = 1; i < arc*radialSegments ; i++ )
	{
		...
		opentop = (i < arc * radialSegments - 1) ? true : false;

                capsule = createCapsule(material, tube, top, bottom, tubularSegments, opentop, false);

		helix.add( capsule );
		//don't recalculate bottom, just copy it from current top
                bottom.copy(top);
	}
	///////////////
