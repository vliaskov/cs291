...
function createBody() {
   ...
   bodycyl = new THREE.Mesh( new THREE.CylinderGeometry( 12, 12, 390, 32, 32, false), cylinderMaterial); 
   bodycyl.position.x = 0;	// centered on origin along X
   bodycyl.position.y = 355;
   bodycyl.position.z = 0;	// offset 77 + half of depth 6/2
   scene.add( bodycyl );
   
   bodysphere = new THREE.Mesh( new THREE.SphereGeometry( 58, 32, 32), sphereMaterial); 
   bodysphere.position.x = 0;	// centered on origin along X
   bodysphere.position.y = 160;
   bodysphere.position.z = 0;	// offset 77 + half of depth 6/2
...
function createHead() {
   ...
   headsphere = new THREE.Mesh( new THREE.SphereGeometry( 52, 32, 32), sphereMaterial); 
   headsphere.position.x = 0;	// centered on origin along X
   headsphere.position.y = 550;
   headsphere.position.z = 0;	// offset 77 + half of depth 6/2
   scene.add( headsphere );  
    
   brim = new THREE.Mesh( new THREE.CylinderGeometry( 71, 71, 10, 32, 32, false), cylinderMaterial); 
   brim.position.x = 0;	// centered on origin along X
   brim.position.y = 590;
   brim.position.z = 0;	// offset 77 + half of depth 6/2
   scene.add( brim );
    
   hat = new THREE.Mesh( new THREE.CylinderGeometry( 40, 40, 70, 32, 32, false), cylinderMaterial); 
   hat.position.x = 0;	// centered on origin along X
   hat.position.y = 600;
   hat.position.z = 0;	// offset 77 + half of depth 6/2
   scene.add( hat ); 
