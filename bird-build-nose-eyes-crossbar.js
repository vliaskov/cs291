...
// Your tas is to modify the createDrinkingBird function around line 160
////////////////////////////////////////////////////////////////////////////////
...
function createDrinkingBird() {
	...
	var cylgeom = new THREE.CylinderGeometry( 5, 5, 200, 32 );
    var crossbar = new THREE.Mesh(cylgeom, crossbarMaterial);
    ...
    var eyegeom = new THREE.SphereGeometry( 10, 32, 32 );
    var eyec1 = new THREE.Object3D();
    var eyec2 = new THREE.Object3D();
	...
	eye1.position.y = 560;
    eyec1.add(eye1);
    eyec1.rotation.x = 2 * Math.PI / 180;
    
    eye2.position.x = -46;
	eye2.position.y = 560;
    eyec2.add(eye2);
    eyec2.rotation.x = -2 * Math.PI / 180;
